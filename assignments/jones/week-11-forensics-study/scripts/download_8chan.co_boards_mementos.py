...
with open("8chan.co-boards-timemap.json") as f:
    jdata = json.load(f)
...
for entry in jdata["mementos"]["list"]:
    ...
    output_filename = 'boards-1st-mementos/' + entry["datetime"] + '.html'
    headers_output_filename = 'boards-1st-mementos/' + entry["datetime"] + '-headers.json'
